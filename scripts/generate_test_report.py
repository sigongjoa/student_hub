...
def run_tests_with_json():
    """pytest를 실행하고 JSON 결과 수집"""
    result = subprocess.run(
        ["python3", "-m", "pytest", "tests/", "-v", "--json-report", "--json-report-file=test_report.json"],
        capture_output=True,
        text=True
    )
...
"""
    ...
    print("✅ Summary report created: reports/TEST_REPORT.md")
    return report

if __name__ == "__main__":
    print("=" * 70)
    print("Node 0 Student Hub - Test Report Generator")
    print("=" * 70)

    print("\n1. Generating HTML test report...")
    ...
    print("  - Summary: reports/TEST_REPORT.md")
